...
// ================= Admin Header Config Schema =================
const PublicSubHeaderConfigSchema = new mongoose.Schema(
  {
...
module.exports =
  mongoose.models.PublicSubHeaderConfigPra ||
  mongoose.model("PublicSubHeaderConfigPra", PublicSubHeaderConfigSchema);
