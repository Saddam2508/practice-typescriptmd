...
const PublicTopHeaderConfigSchema = new mongoose.Schema(
  {
...
module.exports =
  mongoose.models.PublicTopHeaderConfig ||
  mongoose.model("PublicTopHeaderConfig", PublicTopHeaderConfigSchema);
